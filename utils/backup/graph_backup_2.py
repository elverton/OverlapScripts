...
def graph_prob_change_in_old(infos):
    ...
    print "graph_prob_change_in_old"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_prob_change_in_old."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_prob_change_in_old.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_prob_change_in_old.txt","w")
    ...
    plt.ylim(0.0, 1.0)
    plt.savefig('out_prob_change.pdf')
    plt.clf()
...
def graph_cdf_changed_overlap(infos):
    ...
    print "graph_cdf_changed_overlap"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_cdf_changed_overlap."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_cdf_changed_overlap.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_cdf_changed_overlap.txt","w")
    ...
    plt.ylim(0.0, 1.0)
    plt.xlim(0.0, 1.0)
    plt.savefig('out_cdf_changed_overlap.pdf')
    plt.clf()
# ---------------------------------------------------------------------------- #
"""
The goal of this graph is to know better how the overlapping route
LCZs fits in a intersection
"""
def graph_cdf_changed_overlap_ignore_lb(infos):
    ...
    print "graph_cdf_changed_overlap_ignore_lb"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_cdf_changed_overlap_ignore_lb."+infos["node"] ,"w")
            ...
            for j,intersection in enumerate(intersections):
                ...
                for i,change_zone_old in enumerate(overlap_changes_old):
                    ...
                    change_zone_old_hops = path.path_get_subpath(overlap_oldpath,\
                        change_zone_old)
                    coverage_change_zone = statistical.list_intersection(\
                        change_zone_old_hops, intersection_hops, ignore_lb=True)
    ...
    o1 = open("dots/out_cdf_changed_overlap_ignore_lb.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_cdf_changed_overlap_ignore_lb.txt","w")
    for i in changed_overlap:
        print >> o2, i
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.xlim(0.0, 1.0)
    plt.savefig('out_cdf_changed_overlap_ignore_lb.pdf')
    plt.clf()
...
influence into locate a change or not.
"""
def graph_prob_change_in_old_ignore_lb(infos):
    ...
    print "graph_prob_change_in_old_ignore_lb"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_prob_change_in_old_ignore_lb."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_prob_change_in_old_ignore_lb.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_prob_change_in_old_ignore_lb.txt","w")
    for i,j in changes_in_old.items():
        print >> o2, i,j
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.savefig('out_prob_change_ignore_lb.pdf')
    plt.clf()
# -------------------------------------------------------------------------- #
# ----------------------------------------------------------------- #
"""
...
LCZs fits in a intersection
"""
def graph_cdf_changed_overlap_ignore_lb_cut_bj(infos):
    ...
    print "graph_cdf_changed_overlap_ignore_lb_cut_bj"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_cdf_changed_overlap_ignore_lb_cut_bj."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_cdf_changed_overlap_ignore_lb_cut_bj.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_cdf_changed_overlap_ignore_lb_cut_bj.txt","w")
    for i in changed_overlap:
        print >> o2, i
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.xlim(0.0, 1.0)
    plt.savefig('out_cdf_changed_overlap_ignore_lb_cut_bj.pdf')
    plt.clf()
...
influence into locate a change or not.
"""
def graph_prob_change_in_old_ignore_lb_cut_bj(infos):
    ...
    print "graph_prob_change_in_old_ignore_lb_cut_bj"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_prob_change_in_old_ignore_lb_cut_bj."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_prob_change_in_old_ignore_lb_cut_bj.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_prob_change_in_old_ignore_lb_cut_bj.txt","w")
    for i,j in changes_in_old.items():
        print >> o2, i,j
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.savefig('out_prob_change_ignore_lb_cut_bj.pdf')
    plt.clf()
...
LCZs fits in a intersection
"""
def graph_cdf_changed_overlap_cut_bj_v3(infos):
    ...
    print "graph_cdf_changed_overlap_cut_bj_v3"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_cdf_changed_overlap_cut_bj_v3."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_cdf_changed_overlap_cut_bj_v3.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_cdf_changed_overlap_cut_bj_v3.txt","w")
    for i in changed_overlap:
        print >> o2, i
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.xlim(0.0, 1.0)
    plt.savefig('out_cdf_changed_overlap_cut_bj_v3.pdf')
    plt.clf()
...
influence into locate a change or not.
"""
def graph_prob_change_in_old_cut_bj_v2(infos):
    ...
    print "graph_prob_change_in_old_v2"
    for f in intersectionpp_files:
        
        print f
        infos["node"] = f.split(".",1)[1]
        out_ids_intersect = open("ids/ids_prob_change_in_old_v2."+infos["node"] ,"w")
    ...
    o1 = open("dots/out_prob_change_in_old_v2.txt","w")
    for i in range(len(x)):
        print >> o1, x[i],y[i]
    o1.close()

    o2 = open("dots/dots_prob_change_in_old_v2.txt","w")
    for i,j in changes_in_old.items():
        print >> o2, i,j
    o2.close()
    ...
    plt.ylim(0.0, 1.0)
    plt.savefig('out_prob_change_v2.pdf')
    plt.clf()
